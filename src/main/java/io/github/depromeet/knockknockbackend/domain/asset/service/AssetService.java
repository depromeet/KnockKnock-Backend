...
public class AssetService implements AssetUtils {
    ...
    public BackgroundsResponse getAllBackgroundImage() {
        List<BackgroundImageDto> backgroundImageDtos =
                backGroundImageRepository.findAllByOrderByListOrderAsc().stream()
    ...
    public ThumbnailsResponse getAllThumbnailImage() {
        List<ThumbnailImageDto> thumbnailImageDtos =
                thumbnailRepository.findAllByOrderByListOrderAsc().stream()
    ...
    public ProfileImagesResponse getAllProfileImages() {
        List<ProfileImageDto> profileImageDtos =
                profileImageRepository.findAllByOrderByListOrderAsc().stream()
    ...
    public ReactionsResponse getAllReactionImages() {
        List<ReactionImageDto> reactionImageDtos =
                reactionRepository.findAllByOrderByListOrderAsc().stream()
