...
public class AdmissionService implements AdmissionUsecase {
    ...
    public AdmissionInfoListResponse getAdmissions(Long groupId) {
        ...
        List<Admission> Admissions =
                admissionRepository.findByGroupAndAdmissionState(group, AdmissionState.PENDING);

        List<AdmissionInfoDto> admissionInfoDtos =
                Admissions.stream().map(this::getAdmissionInfoDto).collect(Collectors.toList());
